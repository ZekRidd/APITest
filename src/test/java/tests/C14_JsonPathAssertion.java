...
public class C14_JsonPathAssertion {
    @Test
    public void test01(){
         /*
        ...
        JSONObject reserveDates = new JSONObject();

        reserveDates.put("checkin","2021-06-01");
        reserveDates.put("checkout","2021-06-10");

        requestBody.put("firstname","Hasan");
        requestBody.put("lastname","Yagmur");
        requestBody.put("totalprice",500);
        requestBody.put("depositpaid",false);
        requestBody.put("bookingdates",reserveDates);
