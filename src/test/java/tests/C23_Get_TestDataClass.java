...
public class C23_Get_TestDataClass extends BaseUrlJsonPlaceHolder {
    @Test
    public void test01() {
        /*
     ...
     */
        ...
        Assert.assertEquals(TestDataJsonPlaceholder.basariliSorguStatusKodu,response.statusCode());
